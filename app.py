...
def main():
    ...
    col = st.columns(1)  # Create a single column for center alignment
    with col[0]:
         ...
         restecg = st.sidebar.selectbox("RESTING ECG (0=Normal ,1=Having ST-T wave abnormality, 2=Left ventricular hyperthrophy)", ["0", "1", "2"])
         ...
         thal = st.sidebar.radio("THALASSEMIA (0 = normal; 1 = fixed defect; 2 = reversable defect)",["0", "1", "2"])
