...
def main():
    ...
    with col1:
         age = st.sidebar.selectbox("AGE", 21, 81, 23)
    with col2:
    ...
    with col1:
        trestbps = st.sidebar.selectbox("RESTING B.P.", 100, 400, 110)
    with col2:
        chol = st.sidebar.selectbox("CHOLESTEROL", 100, 400, 110)
    with col3:
    ...
    with col2:
        thalach = st.sidebar.selectbox("MAX. HEART BEAT ACHIEVED", 100, 200, 110)
    with col3:
